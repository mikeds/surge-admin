...
class Pastor_transactions extends Admin_Controller {
	...
	public function index($page = 1) {
		$this->_data['form_url'] = base_url() . "pastor-transactions";
		...
		$inner_joints = array(
			...
			array(
				'table_name'	=> 'pastor_accounts as pa1',
				'condition'		=> 'pa1.oauth_bridge_id = transactions.transaction_requested_by',
				'type'			=> 'left'
			),
			array(
				'table_name'	=> 'pastor_accounts as pa2',
				'condition'		=> 'pa2.oauth_bridge_id = transactions.transaction_requested_to',
				'type'			=> 'left'
			)
		);
		...
		$this->set_template("pastor_transactions/list", $this->_data);
	}
